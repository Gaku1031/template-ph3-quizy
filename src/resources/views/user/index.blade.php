...
<body>
  <header class="p-header">
    ...
    <nav class="p-header__nav">
        ...
        <a href="{{ route('study_record') }}" class="p-header__nav__record">記録・投稿</a>
    </nav>
  </header>
...
<main class="p-main">
    ...
    <div class="overlay"></div>
      ...
      <div class="submit-study-record">
        ...
        <div class="pop__left">
          ...
          <div class="contents">
            <label class="label">
              <input type="checkbox" class="input__checkbox" value="1" name="contents[]">
              <span class="checkbox"></span>N予備校
            </label>
            <label class="label">
              <input type="checkbox" class="input__checkbox" value="2" name="contents[]"><span
                class="checkbox"></span>ドットインストール
            </label>
            <div class="space-1"></div>
            <label class="label">
              <input type="checkbox" class="input__checkbox" name="contents" value="3" name=contents[]><span class="checkbox"></span>POSSE課題
            </label>
          </div>
          ...
          <div class="languages">
            ...
            <div class="space-1"></div>
            <label class="label">
              <input type="checkbox" class="input__checkbox" name="languages[]" value="others"><span
  ...
  {{-- <div class="window3">
    ...
    <div class="completion" id="completion">
      <input type="button" class="close" id="close-success-page" value="×">
